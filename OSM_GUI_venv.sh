# ###############################################################################################
#
#  This Script is to set up the packages for the environment "OSM_GUI_venv"
#  It provieds a quick recreation of the virtual environment
#    Location: C:\Anaconda3\envs\OSM_GUI_venv
#    
...
#   --> ipython package installed with requirements_cond.txt
#
